...
cover_story = '''
I am writing to express my keen interest in the Software Developer Intern role. 
Currently pursuing a B.Tech in Computer Science, I have a solid foundation in Python and relevant 
